...
from calcul_mod.triganometry import siiin, cosinus, tangens, cotangens, sec, cosec
import sys
    ...
    try:
        ...
        while (isEnd == False):
            ...
            #тригономметрия 
                ...
                a = int(input("введите число:"))
                if a % 180 == 90:
                    print("\n \033[43;30m ошибка. из этого числа нельзя вычислить тангенс\033[0m")
                else:
                    res = tangens(a)
                    print("Результат:", res, "  Приблизительно равно:", round(res, 3))   
                isEnd = True
                ...
                a = int(input("введите число:"))
                if a % 180 == 0:
                    print("\n \033[43;30m ошибка. из этого числа нельзя вычислить котангенс\033[0m")
                else:
                    res = tangens(a)
                    print("Результат:", res, "  Приблизительно равно:", round(res, 3))   
                isEnd = True
            elif (operation == "$6(" or operation == "секанс"):
                a = int(input("введите число:"))
                if a % 180 == 90:
                    print("\n \033[43;30m ошибка. из этого числа нельзя вычислить секанс\033[0m")
                else:
                    res = sec(a)
                    print("Результат:", res, "  Приблизительно равно:", round(res, 3))   
                isEnd = True
            elif (operation == "($(" or operation == "косеканс"):
                a = int(input("введите число:"))
                if a % 180 == 0:
                    print("\n \033[43;30m ошибка. из этого числа нельзя вычислить косеканс\033[0m")
                else:
                    res = cosec(a)
                    print("Результат:", res, "  Приблизительно равно:", round(res, 3))   
                isEnd = True
